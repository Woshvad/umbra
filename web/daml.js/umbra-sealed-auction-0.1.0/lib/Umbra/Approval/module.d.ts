...
export declare const ClearingApproval:
  damlTypes.Template<ClearingApproval, undefined, '#umbra-sealed-auction:Umbra.Approval:ClearingApproval'> &
...
export declare const ClearingApprovalRequest:
  damlTypes.Template<ClearingApprovalRequest, undefined, '#umbra-sealed-auction:Umbra.Approval:ClearingApprovalRequest'> &
