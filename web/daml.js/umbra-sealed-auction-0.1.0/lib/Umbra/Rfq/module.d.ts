...
export declare const Quote:
  damlTypes.Template<Quote, undefined, '#umbra-sealed-auction:Umbra.Rfq:Quote'> &
...
export declare const RfqRequest:
  damlTypes.Template<RfqRequest, undefined, '#umbra-sealed-auction:Umbra.Rfq:RfqRequest'> &
