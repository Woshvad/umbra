...
import { Order } from '@daml.js/umbra-sealed-auction-0.1.0/lib/Umbra/Auction/module'
...
import { Side } from '@daml.js/umbra-sealed-auction-0.1.0/lib/Umbra/Clearing/module'
